...
class MainActivity : AppCompatActivity() {
     ...
     * @Override public int createViewHolder(int viewType) {
     ...
     * }
     *
     * @Override public void bindViewHolder(ViewHolder viewHolder, JSONObject jsonObject, int position, Object payload) {
